    ...
    <div className="contenedor-pagina">
      ...
      <div className="cosas">
        <p className="cursiva">¿Qué pasa si llueve?  </p>
          ...
          locación. Te vamos a avisar algunos días antes! Nos vamos a Mi Rancho - Newton y El Lirio, Ruta 3 km 39.5 - Virrey del Pino podes seguir la ubicación <a href="https://goo.gl/maps/MumXfXbnzreToQ3o8">aca</a>! </p> 
